...
async function runFullScanAnalysis(images){
  ...
  try{
    ...
    setScanState('Analysis complete ✓ · Continue to Profile');
    return true;
  }catch(e){
    clearInterval(stageTimer);
